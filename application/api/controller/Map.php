        ...
        try{
            ...
            if($user_city_list) {
                ...
                if($city_list) {
                    ...
                    $parent_list = Db::table('map_citys')->field('id, name, pinyin')->where(['level_type' => ['eq', 1], 'id' => ['in', array_keys($city_info)]])->select();
                    if(!$parent_list) {
                    ...
                    foreach ((array)$parent_list as $vals) {
                        ...
                        $color_list[strtolower($vals['pinyin'])] = ['stateInitColor' => rand(0, 1052)];
                    }
